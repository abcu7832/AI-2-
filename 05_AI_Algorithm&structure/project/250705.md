...
* 아 코드를 download_landmark_model.py 같은 이름으로 저장
```
import urllib.request
import os

url = "http://dlib.net/files/shape_predictor_68_face_landmarks.dat.bz2"
output_bz2 = "shape_predictor_68_face_landmarks.dat.bz2"
output_dat = "shape_predictor_68_face_landmarks.dat"

# 1) bz2 파일 다운로드
if not os.path.exists(output_bz2):
    print("Downloading shape_predictor_68_face_landmarks.dat.bz2...")
    urllib.request.urlretrieve(url, output_bz2)
else:
    print(f"{output_bz2} already exists.")
...
if not os.path.exists(output_dat):
    ...
    print(f"Extraction done. {output_dat} is ready!")
else:
    print(f"{output_dat} already exists.")
```
