...
fprintf('===== Scalar and Vector Variables =====\n\n');
...
printVector('row_sum', row_sum);
printVector('col_sum', col_sum);
printVector('row_mean', row_mean);
printVector('col_mean', col_mean);
