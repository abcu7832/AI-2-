...
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports {motor_direction[0]}]
set_property -dict { PACKAGE_PIN W17   IOSTANDARD LVCMOS33 } [get_ports {motor_direction[1]}]
...
#set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports sw[1]]
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports BTND]


##Pmod Header JA
set_property -dict { PACKAGE_PIN J1   IOSTANDARD LVCMOS33 } [get_ports {o_run}];#Sch name = JA1
